...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;font-family:"Microsoft Yahei",Arial,sans-serif;}
        ...
        input[type="submit"]{width:100%;padding:12px;background:#2ecc71;color:#fff;border:none;border-radius:8px;font-size:16px;cursor:pointer;transition:background .3s,transform .2s;}
        input[type="submit"]:hover{background:#27ae60;transform:translateY(-2px);}
